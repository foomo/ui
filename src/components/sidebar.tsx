...
function SidebarGroupLabel({
	...
	return (
		<Comp
			...
			className={cn(
				"lib:flex lib:h-8 lib:shrink-0 lib:items-center lib:rounded-md lib:px-3 lib:text-xs lib:font-medium lib:text-sidebar-foreground/70 lib:ring-sidebar-ring lib:outline-hidden lib:transition-[margin,opacity] lib:duration-200 lib:ease-linear lib:group-data-[collapsible=icon]:-mt-8 lib:group-data-[collapsible=icon]:opacity-0 lib:focus-visible:ring-2 lib:[&>svg]:size-4 lib:[&>svg]:shrink-0",
				className,
			)}
			{...props}
		/>
...
function SidebarGroupAction({
	...
	return (
		<Comp
			...
			className={cn(
				"lib:absolute lib:top-3.5 lib:right-3 lib:flex lib:aspect-square lib:w-5 lib:items-center lib:justify-center lib:rounded-md lib:p-0 lib:text-sidebar-foreground lib:ring-sidebar-ring lib:outline-hidden lib:transition-transform lib:group-data-[collapsible=icon]:hidden lib:after:absolute lib:after:-inset-2 lib:hover:bg-sidebar-accent lib:hover:text-sidebar-accent-foreground lib:focus-visible:ring-2 lib:md:after:hidden lib:[&>svg]:size-4 lib:[&>svg]:shrink-0",
				className,
			)}
			{...props}
		/>
...
function SidebarMenuAction({
	...
	return (
		<Comp
			...
			className={cn(
				"lib:absolute lib:top-1.5 lib:right-1 lib:flex lib:aspect-square lib:w-5 lib:items-center lib:justify-center lib:rounded-md lib:p-0 lib:text-sidebar-foreground lib:ring-sidebar-ring lib:outline-hidden lib:transition-transform lib:group-data-[collapsible=icon]:hidden lib:peer-hover/menu-button:text-sidebar-accent-foreground lib:peer-data-[size=default]/menu-button:top-2 lib:peer-data-[size=lg]/menu-button:top-2.5 lib:peer-data-[size=sm]/menu-button:top-1 lib:after:absolute lib:after:-inset-2 lib:hover:bg-sidebar-accent lib:hover:text-sidebar-accent-foreground lib:focus-visible:ring-2 lib:md:after:hidden lib:[&>svg]:size-4 lib:[&>svg]:shrink-0",
				showOnHover &&
					"lib:group-focus-within/menu-item:opacity-100 lib:group-hover/menu-item:opacity-100 lib:peer-data-active/menu-button:text-sidebar-accent-foreground lib:aria-expanded:opacity-100 lib:md:opacity-0",
				className,
			)}
			{...props}
		/>
...
function SidebarMenuSubButton({
	...
	return (
		<Comp
			...
			data-active={isActive}
			className={cn(
				"lib:flex lib:h-7 lib:min-w-0 lib:-translate-x-px lib:items-center lib:gap-2 lib:overflow-hidden lib:rounded-md lib:px-2 lib:text-sidebar-foreground lib:ring-sidebar-ring lib:outline-hidden lib:group-data-[collapsible=icon]:hidden lib:hover:bg-sidebar-accent lib:hover:text-sidebar-accent-foreground lib:focus-visible:ring-2 lib:active:bg-sidebar-accent lib:active:text-sidebar-accent-foreground lib:disabled:pointer-events-none lib:disabled:opacity-50 lib:aria-disabled:pointer-events-none lib:aria-disabled:opacity-50 lib:data-[size=md]:text-sm lib:data-[size=sm]:text-xs lib:data-active:bg-sidebar-accent lib:data-active:text-sidebar-accent-foreground lib:[&>span:last-child]:truncate lib:[&>svg]:size-4 lib:[&>svg]:shrink-0 lib:[&>svg]:text-sidebar-accent-foreground",
				className,
			)}
			{...props}
		/>
