...
>(({ className, ...props }, ref) => {
	...
	return (
		<div ref={carouselRef} className="lib:overflow-hidden">
			<div
				ref={ref}
				className={cn(
					"lib:flex",
...
>(({ className, variant = "outline", size = "icon", ...props }, ref) => {
	...
	return (
		<Button
			...
			size={size}
			className={cn(
				"lib:absolute lib: lib:h-8 lib:w-8 lib:rounded-full",
				orientation === "horizontal"
					? "lib:-left-12 lib:top-1/2 lib:-translate-y-1/2"
			...
			{...props}
		>
			<ArrowLeft className="lib:h-4 lib:w-4" />
...
>(({ className, variant = "outline", size = "icon", ...props }, ref) => {
	...
	return (
		<Button
			...
			size={size}
			className={cn(
				"lib:absolute lib:h-8 lib:w-8 lib:rounded-full",
				orientation === "horizontal"
					? "lib:-right-12 lib:top-1/2 lib:-translate-y-1/2"
			...
			{...props}
		>
			<ArrowRight className="lib:h-4 lib:w-4" />
